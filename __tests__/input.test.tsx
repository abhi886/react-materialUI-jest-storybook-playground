...
fireEvent.change(screen.getByTestId("search-id"), { target: { value: 'test' } });
...
expect(screen.queryByPlaceholderText("Search Catalogue...")).not.toBeInTheDocument();
});
...
it("renders with outlined variant", () => {
  ...
  const inputWrapper = screen.getByLabelText("Search-Catalogue").parentElement;
