   ...
   <Grid container spacing={4}>
    ...
    <Grid size={6} >
        ...
        >
          ...
          <Tag label="Outlined Secondary" variant="outlined" color="secondary" />
...
export const Selected:Story = {
    ...
    {/* <p>Outlined</p> */}
      {/* Outlined column */}
        ...
        >
          ...
          <Tag label="Unselected Secondary" variant="outlined" color="secondary" />
  ...
  <Grid size={6} >
        <Box
          ...
          p={2}
        >
          <Tag label="Selected Default" variant="outlined" color="default" selected/>
          <Tag label="Selected Primary" variant="outlined" color="primary" selected/>
          <Tag label="Selected Secondary" variant="outlined" color="secondary" selected/>
          <Tag label="Selected Error" variant="outlined" color="error" selected/>
          <Tag label="Selected Info" variant="outlined" color="info" selected/>
          <Tag label="Selected Success" variant="outlined" color="success" selected/>
          <Tag label="Selected Warning" variant="outlined" color="warning" selected/>
        </Box>
      </Grid>
  ...
  <Grid size={6} >
       ...
       <Grid size={6} >
        <Box
          ...
          p={2}
        >
          <Tag label="Filled Default" variant="filled" color="default" selected={true}/>
          <Tag label="Filled Primary" variant="filled" color="primary" selected={true}/>
          <Tag label="Filled Secondary" variant="filled" color="secondary" selected={true}/>
          <Tag label="Filled Error" variant="filled" color="error" selected={true}/>
          <Tag label="Filled Info" variant="filled" color="info" selected={true}/>
          <Tag label="Filled Success" variant="filled" color="success" selected={true}/>
          <Tag label="Filled Warning" variant="filled" color="warning" selected={true}/>
        </Box>
      </Grid>
    </Grid>
    )
